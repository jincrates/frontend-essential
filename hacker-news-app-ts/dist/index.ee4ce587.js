...
})({"gAHr2":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
function appliyApiMixins(targetClass, baseClasses) {
    baseClasses.forEach((baseClass)=>{
        Object.getOwnPropertyNames(baseClass.prototype).forEach((name)=>{
            const descripter = Object.getOwnPropertyDescriptor(baseClass.prototype, name);
            if (descripter) Object.defineProperty(targetClass.prototype, name, descripter);
        });
    });
}
//class 생성
...
class NewsFeedView extends View {
    ...
    makeFeeds() {
        for(let i = 0, max = this.feeds.length; i < max; i++)this.feeds[i].read = false;
    }
}
class NewsDetailView extends View {
    ...
    render() {
        ...
        for(let i = 0, max = store.feeds.length; i < max; i++)if (store.feeds[i].id === Number(id)) {
...
},{}]},["gAHr2","85GYl"], "85GYl", "parcelRequire94c2")
