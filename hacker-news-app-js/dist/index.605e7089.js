...
})({"gLFQw":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "027f7d63605e7089";
"use strict";
...
},{}],"1TPae":[function(require,module,exports) {
...
function newsFeed() {
    ...
    for(let i = store.currentPage - 1; i < store.currentPage * 10; i++)newsList.push(`
    ...
    let template = `
        <div class="bg-gray-600 min-h-screen pb-8">
            ...
            <div class="h-full border rounded-xl bg-white m-6 p-4 ">
                <h2><a href="${newsContent.url}" onclick="window.open(this.href); return false;">${newsContent.title}</a></h2>
...
},{}]},["gLFQw","1TPae"], "1TPae", "parcelRequire5d2d")

//# sourceMappingURL=index.605e7089.js.map
